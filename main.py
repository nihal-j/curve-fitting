...
def plot_loss(errors, numIters, interval):
    ...
    '''
    Plots the errors as a function of iteration index using matplotlib.

    Arguments:
        errors:     error values as a Python list.
        numIters:   number of iterations for which errors have been calculated.
        interval:   interval of iterations between successive plots.
    '''
...
if __name__ == '__main__':
    ...
    featureMatrix, _ = preprocessing.generate_features(x_train, y_train, trainCount, deg)
